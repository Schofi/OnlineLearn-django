...
class CourseAdmin(object):
    list_display = ['name', 'desc', 'detail', 'degree', 'students','fav_nums', 'image', 'click_nums','add_time']  # 一次显示你想出现的多行数据
    search_fields = ['name', 'desc', 'detail', 'degree', 'students']  # 查询你想要的数据
